...
final class TestSuite8 implements TestSuiteInterface {
    ...
    public function getTitle(): string {
        return "Instantiating a few small object graphs - Prototype scope";
    }
    ...
    public function getDescription(): string {
        return <<<HERE
This test suite instantiates 3 different objects, repeated 10, 20, and 30 times. It demonstrates how containers perform when only a few objects are initialized, while still having to manage a large number of cached or defined services. This mirrors real-world scenarios where most requests require only a small subset of services, but containers must still handle the overhead of loading definitions or cache.
HERE;
    }
